...
public class StepDefinitions {
    ...
    @Then("^I (should|shouldnot) see the entries of todolist in \"([^\"]*)\" filter$")
    public void i_see_the_entries_of_todolist_task_in_filter(String condition, String filter) throws Throwable {
    ...
    @Then("^I (should|shouldnot) see \"([^\"]*)\" filter is displayed$")
    public void i_should_see_filter_is_displayed(String condition, String filter) throws Throwable {
    ...
    public void i_should_see_page(String page) throws Throwable {
    ...
    public void i_click_on_filter(String filter) throws Throwable {
        switch (filter) {
            case ALL:
    ...
    public void i_click_on_task_on_todo_list(DataTable dataTable) {
        todoListobj.clickTaskOnFilter(dataTable);
    }

    @Then("I see the listSummary count is reduced by number of completed tasks in {string} filter")
    public void i_see_the_listSummary_count_is_reduced_by_number_of_completed_tasks(String filter) throws Throwable {
    ...
    public void iClickOnMarkAllAsCompletedDropMark() {
